...
int main()
{
    ...
    using type1 = Qu<intBits<18>, fracBits<-9>, isSigned<true>, QuMode<RND::NEG_INF>, OfMode<SAT::ZERO>>; 
    using type2 = Qu<intBits<18>, fracBits<-9>, isSigned<true>, QuMode<RND::NEG_INF>, OfMode<SAT::SMGN>>; 
